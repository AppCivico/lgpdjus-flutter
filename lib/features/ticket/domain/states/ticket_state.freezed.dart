...
/// @nodoc
class _$TicketStateTearOff {
  const _$TicketStateTearOff();

  _Initial initial() {
    return const _Initial();
  }

  _Loaded loaded(List<Tile> tiles) {
    return _Loaded(
      tiles,
    );
  }
...
/// @nodoc
const $TicketState = _$TicketStateTearOff();
...
mixin _$TicketState {
  ...
  TResult when<TResult extends Object?>({
    ...
    required TResult Function(List<Tile> tiles) loaded,
  ...
  TResult? whenOrNull<TResult extends Object?>({
    ...
    TResult Function(List<Tile> tiles)? loaded,
...
/// @nodoc
class __$InitialCopyWithImpl<$Res> extends _$TicketStateCopyWithImpl<$Res>
...
class _$_Initial with DiagnosticableTreeMixin implements _Initial {
  ...
  void debugFillProperties(DiagnosticPropertiesBuilder properties) {
    ...
    properties.add(DiagnosticsProperty('type', 'TicketState.initial'));
  }
...
/// @nodoc
class __$LoadedCopyWithImpl<$Res> extends _$TicketStateCopyWithImpl<$Res>
...
class _$_Loaded with DiagnosticableTreeMixin implements _Loaded {
  ...
  @override
  String toString({DiagnosticLevel minLevel = DiagnosticLevel.info}) {
    return 'TicketState.loaded(tiles: $tiles)';
  }
  ...
  void debugFillProperties(DiagnosticPropertiesBuilder properties) {
    super.debugFillProperties(properties);
    properties
      ..add(DiagnosticsProperty('type', 'TicketState.loaded'))
...
abstract class _Loaded implements TicketState {
  const factory _Loaded(List<Tile> tiles) = _$_Loaded;
...
/// @nodoc
class __$EmptyCopyWithImpl<$Res> extends _$TicketStateCopyWithImpl<$Res>
...
class _$_Empty with DiagnosticableTreeMixin implements _Empty {
  ...
  void debugFillProperties(DiagnosticPropertiesBuilder properties) {
    super.debugFillProperties(properties);
    properties.add(DiagnosticsProperty('type', 'TicketState.empty'));
  }
...
abstract class _Empty implements TicketState {
...
/// @nodoc
class __$ErrorDetailsCopyWithImpl<$Res> extends _$TicketStateCopyWithImpl<$Res>
...
class _$_ErrorDetails with DiagnosticableTreeMixin implements _ErrorDetails {
  ...
  @override
  String toString({DiagnosticLevel minLevel = DiagnosticLevel.info}) {
    return 'TicketState.error(message: $message)';
  }
  ...
  void debugFillProperties(DiagnosticPropertiesBuilder properties) {
    super.debugFillProperties(properties);
    properties
      ..add(DiagnosticsProperty('type', 'TicketState.error'))
...
abstract class _ErrorDetails implements TicketState {
