...
class _$DetailsStateTearOff {
  ...
  _Loaded loaded(DetailsScreen screen) {
    return _Loaded(
      screen,
    );
  }

  _Failed failed(Object error) {
    return _Failed(
      error,
    );
  }
...
mixin _$DetailsState {
  ...
  TResult when<TResult extends Object?>({
    ...
    required TResult Function(DetailsScreen screen) loaded,
  ...
  TResult? whenOrNull<TResult extends Object?>({
    ...
    TResult Function(DetailsScreen screen)? loaded,
...
class _$_Loaded implements _Loaded {
  ...
  @override
  String toString() {
    return 'DetailsState.loaded(screen: $screen)';
  }
...
abstract class _Loaded implements DetailsState {
  const factory _Loaded(DetailsScreen screen) = _$_Loaded;

  DetailsScreen get screen => throw _privateConstructorUsedError;
  @JsonKey(ignore: true)
...
class _$_Failed implements _Failed {
  ...
  @override
  String toString() {
    return 'DetailsState.failed(error: $error)';
  }
...
abstract class _Failed implements DetailsState {
  const factory _Failed(Object error) = _$_Failed;
