...
class BirthdayEditTextTileWidget extends StatefulWidget {
  BirthdayEditTextTileWidget(this.editText, {Key? key})
      : super(key: key ?? ValueKey(editText));

  final EditTextTile editText;

  @override
  _BirthdayEditTextTileWidgetState createState() =>
      _BirthdayEditTextTileWidgetState();
}

class _BirthdayEditTextTileWidgetState extends ModularWidgetState<
    BirthdayEditTextTileWidget, QuizReplyController> {
  ...
  void _onTextChanged(String text) {
    setState(() {
      final value = text.split('/').reversed.join('-');
